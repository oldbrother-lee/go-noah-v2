...
type AdminCreateDBConfigForm struct {
	...
	UserName        string                 `form:"user_name"  json:"user_name" binding:"required,min=2,max=128"`
	Password        string                 `form:"password"  json:"password" binding:"required,min=2,max=256"`
